...
/**
 * Phase BE-3: Nâng cấp product suggestion cho AI Doctor.
 *
 * Trách nhiệm:
...
@Slf4j
public class AiDoctorProductSuggestionService {

    private final ProductRepository productRepository;
    private final InventoryRepository inventoryRepository;
    private final AiDoctorDiseaseProductMapping diseaseMapping;
    ...
    public List<Product> getCandidateProductsForDisease(String diseaseCode) {
        List<Product> all = productRepository.findActiveProductsForAiDoctor(ProductStatus.ACTIVE);
        ...
        log.info("[AiDoctor] candidateProducts diseaseCode={}, pool={}, selected={}",
