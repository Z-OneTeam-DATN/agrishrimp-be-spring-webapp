...
public class AiDoctorDiagnosisHistoryService {
    ...
    private AiDoctorDiagnosisResponse toFullDetailResponse(AiDoctorDiagnosisHistory h) {
        ...
        return AiDoctorDiagnosisResponse.builder()
                ...
                .stageSelection(resolveStageSelection(h))
                .purchaseUrl(h.getPurchaseUrl())
                .needsClarification(h.getNeedsClarification())
                .status(h.getStatus() != null ? h.getStatus() : "DISEASE")
                .createdAt(h.getCreatedAt())
                .build();
    }
    ...
    private TreatmentStageSelectionResponse readStageSelection(String json) {
        ...
        try {
            ...
            log.warn("[AiDoctor-History] treatment stage json parse fail: {}", ex.getMessage());
            return null;
        }
    }
