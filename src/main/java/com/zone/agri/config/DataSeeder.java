...
public class DataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                Permission aChkA = pAct("Duyệt phiếu kiểm kê", "INVENTORY_CHECK_APPROVE", PermissionGroup.INVENTORY,
                                mChk);
        ...
        private void seedDemoData() {
                ...
                Supplier supTom = supplierRepository.save(Supplier.builder()
                                ...
                                .provinceId("79").addressDetail("KCN Tân Tạo, Q.Bình Tân, TP.HCM")
                                .status(SupplierStatus.ACTIVE).build());
                ...
                Supplier supMW = supplierRepository.save(Supplier.builder()
                                ...
                                .provinceId("92").addressDetail("KCN Trà Nóc 1, Q.Bình Thủy, TP.Cần Thơ")
                                .status(SupplierStatus.ACTIVE).build());

                // ── 1. CHI NHÁNH & KHO ──────────────────────────────────────────
                Branch mainWh = saveBranch("MAIN_WH", "WAREHOUSE", "Kho Tổng Cần Thơ", "02921112222",
                                "khotong@agrishrimp.vn", "99 Nguyễn Văn Cừ, P.An Khánh, Q.Ninh Kiều, Cần Thơ", 10.0341,
                                105.7904, 92, 916);
                Branch branch1 = saveBranch("BRANCH_01", "STORE", "Chi Nhánh Cần Thơ", "02923334444",
                                "cn1@agrishrimp.vn", "15 Mậu Thân, P.Xuân Khánh, Q.Ninh Kiều, Cần Thơ", 10.0300,
                                105.7700, 92, 916);
                Branch branch2 = saveBranch("BRANCH_02", "STORE", "Chi Nhánh Sóc Trăng", "02995556666",
                                "cn2@agrishrimp.vn", "21 Trần Hưng Đạo, P.1, TP.Sóc Trăng, Sóc Trăng", 9.6025, 105.9731,
                                94, 941);
                Branch branch3 = saveBranch("BRANCH_03", "STORE", "Chi Nhánh Bạc Liêu", "02913330001",
                                "cn3@agrishrimp.vn", "12 Ngô Đức Kế, P.7, TP.Bạc Liêu", 9.2940, 105.7216, 95, 950);
                Branch branch4 = saveBranch("BRANCH_04", "STORE", "Chi Nhánh Cà Mau", "02903330002",
                                "cn4@agrishrimp.vn", "45 Phan Ngọc Hiển, P.1, TP.Cà Mau", 9.1769, 105.1500, 96, 964);
                Branch branch5 = saveBranch("BRANCH_05", "STORE", "Chi Nhánh Kiên Giang", "02973330003",
                                "cn5@agrishrimp.vn", "30 Lê Lợi, P.Vĩnh Thanh, TP.Rạch Giá", 10.0129, 105.0802, 91,
                                910);
                Branch branch6 = saveBranch("BRANCH_06", "STORE", "Chi Nhánh An Giang", "02963330004",
                                "cn6@agrishrimp.vn", "25 Hùng Vương, P.Mỹ Long, TP.Long Xuyên", 10.3763, 105.4350, 89,
                                884);
                Branch branch7 = saveBranch("BRANCH_07", "STORE", "Chi Nhánh Bến Tre", "02753330005",
                                "cn7@agrishrimp.vn", "18 Nguyễn Đình Chiểu, P.1, TP.Bến Tre", 10.2417, 106.3754, 83,
                                831);
                Branch branch8 = saveBranch("BRANCH_08", "STORE", "Chi Nhánh Trà Vinh", "02943330006",
                                "cn8@agrishrimp.vn", "31 Điện Biên Phủ, P.4, TP.Trà Vinh", 9.9513, 106.3420, 84, 842);
                Branch branch9 = saveBranch("BRANCH_09", "STORE", "Chi Nhánh Tiền Giang", "02733330007",
                                "cn9@agrishrimp.vn", "10 Lý Thường Kiệt, P.1, TP.Mỹ Tho", 10.3600, 106.3600, 82, 826);
                Branch branch10 = saveBranch("BRANCH_10", "STORE", "Chi Nhánh Long An", "02723330008",
                                "cn10@agrishrimp.vn", "56 Hùng Vương, P.2, TP.Tân An", 10.5351, 106.4053, 80, 799);
                Branch branch11 = saveBranch("BRANCH_11", "STORE", "Chi Nhánh Vĩnh Long", "02703330009",
                                "cn11@agrishrimp.vn", "22 Phạm Thái Bường, P.1, TP.Vĩnh Long", 10.2566, 105.9721, 86,
                                861);
                Branch branch12 = saveBranch("BRANCH_12", "STORE", "Chi Nhánh Đồng Tháp", "02773330010",
                                "cn12@agrishrimp.vn", "88 Nguyễn Sinh Sắc, P.1, TP.Cao Lãnh", 10.4591, 105.6349, 87,
                                871);

                // ── 2. NGƯỜI DÙNG DEMO ───────────────────────────────────────────
                User kho1 = saveUser("Trần Thị Kho Một", "kho1@agrishrimp.vn", "0901000002", "123456", managerRole,
                                mainWh, Gender.FEMALE, LocalDate.of(1992, 7, 20));
                User kho2 = saveUser("Lê Văn Kho Hai", "kho2@agrishrimp.vn", "0901000003", "123456", managerRole,
                                branch1, Gender.MALE, LocalDate.of(1993, 11, 5));
                User user1 = saveUser("Nguyễn Văn Tôm", "user1@gmail.com", "0911000001", "123456", userRole, null,
                                Gender.MALE, LocalDate.of(1988, 6, 12));
                User user2 = saveUser("Trần Thị Cua", "user2@gmail.com", "0911000002", "123456", userRole, null,
                                Gender.FEMALE, LocalDate.of(1990, 9, 25));
                User user3 = saveUser("Lê Minh Nuôi", "user3@gmail.com", "0911000003", "123456", userRole, null,
                                Gender.MALE, LocalDate.of(1995, 2, 18));
                User user4 = saveUser("Phạm Hữu Cá", "user4@gmail.com", "0911000004", "123456", userRole, null,
                                Gender.MALE, LocalDate.of(1992, 5, 10));
                User kho3 = saveUser("Phạm Văn Bạc Liêu", "kho3@agrishrimp.vn", "0901000004", "123456", managerRole,
                                branch3, Gender.MALE, LocalDate.of(1994, 3, 10));
                User kho4 = saveUser("Nguyễn Thị Cà Mau", "kho4@agrishrimp.vn", "0901000005", "123456", managerRole,
                                branch4, Gender.FEMALE, LocalDate.of(1991, 8, 22));
                User kho5 = saveUser("Lê Văn Kiên Giang", "kho5@agrishrimp.vn", "0901000006", "123456", staffRole,
                                branch5, Gender.MALE, LocalDate.of(1996, 5, 15));
                User kho6 = saveUser("Trần Thị An Giang", "kho6@agrishrimp.vn", "0901000007", "123456", staffRole,
                                branch6, Gender.FEMALE, LocalDate.of(1993, 12, 3));
                User kho7 = saveUser("Võ Văn Bến Tre", "kho7@agrishrimp.vn", "0901000008", "123456", staffRole, branch7,
                                Gender.MALE, LocalDate.of(1995, 7, 18));
                User kho8 = saveUser("Huỳnh Thị Trà Vinh", "kho8@agrishrimp.vn", "0901000009", "123456", staffRole,
                                branch8, Gender.FEMALE, LocalDate.of(1992, 4, 30));
                User kho9 = saveUser("Dương Văn Tiền Giang", "kho9@agrishrimp.vn", "0901000010", "123456", staffRole,
                                branch9, Gender.MALE, LocalDate.of(1994, 9, 12));
                User kho10 = saveUser("Bùi Thị Long An", "kho10@agrishrimp.vn", "0901000011", "123456", staffRole,
                                branch10, Gender.FEMALE, LocalDate.of(1997, 1, 25));
                User kho11 = saveUser("Phan Văn Vĩnh Long", "kho11@agrishrimp.vn", "0901000012", "123456", staffRole,
                                branch11, Gender.MALE, LocalDate.of(1993, 6, 8));
                User kho12 = saveUser("Ngô Thị Đồng Tháp", "kho12@agrishrimp.vn", "0901000013", "123456", staffRole,
                                branch12, Gender.FEMALE, LocalDate.of(1996, 11, 17));
                User khoCn2 = saveUser("Nguyễn Văn Sóc Trăng", "cn2mgr@agrishrimp.vn", "0901000014", "123456",
                                managerRole, branch2, Gender.MALE, LocalDate.of(1992, 4, 18));

                // ── 5. DANH MỤC ──────────────────────────
                Category catFeed = categoryRepository.save(cat("Thức Ăn Thủy Sản", null,
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/cat-feed_pjm6uv.jpg"));
                Category catChem = categoryRepository.save(cat("Thuốc & Chế Phẩm Sinh Học", null,
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/cat-chem_v8w3zv.jpg"));
                Category catMine = categoryRepository.save(cat("Khoáng Chất & Dinh Dưỡng", null,
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/cat-min_p8v6zv.jpg"));
                Category catEquip = categoryRepository.save(cat("Dụng Cụ & Trang Thiết Bị", null,
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/cat-equip_v8w3zv.jpg"));
                ...
                Brand bTomboy = brandRepository
                                .save(Brand.builder().name("Tomboy Feed").status(BrandStatus.ACTIVE).build());
                Brand bGN = brandRepository
                                .save(Brand.builder().name("Green Nature").status(BrandStatus.ACTIVE).build());
                ...
                Product p1 = prod("Thức Ăn Tôm CP 8012", "thuc-an-tom-cp-8012",
                                "Thức ăn viên chìm cho tôm thẻ", "Thức ăn tôm CP 8012...", bCP, catSF, "Việt Nam",
                                "CP8012",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p1_pjm6uv.jpg");
                ...
                skua(pv1a, attrW, av5kg);
                skua(pv1a, attrP, avBag);
                skua(pv1b, attrW, av25kg);
                skua(pv1b, attrP, avSack);

                Product p4 = prod("Chế Phẩm EM Xử Lý Ao Nuôi", "che-pham-em",
                                "Vi khuẩn có lợi làm sạch đáy ao", "Chế phẩm EM chứa Bacillus...", bGN, catPro,
                                "Việt Nam", "EM-XL",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p4_v8w3zv.jpg");
                p4.getSuppliers().add(supGN);
                productRepository.save(p4);

                ProductVariant pv4a = pv(p4, "EM-XL-500ML", "8935004001011", VariantStatus.ACTIVE);
                skua(pv4a, attrW, av500g);
                skua(pv4a, attrP, avBottle);

                Product p2 = prod("Thức Ăn Tôm Tomboy #1 Ươm Giống", "thuc-an-tom-tomboy-1",
                                "Thức ăn micro-pellet ươm giống tôm thẻ chân trắng",
                                "Tomboy #1 giàu protein 42%, lipid 8%...", bTomboy, catSF, "Việt Nam", "TBY-1",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p2_p8v6zv.jpg");
                ...
                skua(pv2a, attrW, av500g);
                skua(pv2a, attrP, avBag);
                skua(pv2b, attrW, av5kg);
                skua(pv2b, attrP, avBag);

                Product p3 = prod("Khoáng Tổng Hợp EDTA Agri-Min", "khoang-edta-tong-hop",
                                "Bổ sung khoáng đa vi lượng Ca, Mg, K, Na cho ao tôm",
                                "Khoáng EDTA hỗn hợp Ca-Mg-K-Na dạng bột tan nhanh...", bGN, catMin, "Việt Nam",
                                "GN-EDTA",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p3_v8w3zv.jpg");
                ...
                skua(pv3a, attrW, av1kg);
                skua(pv3a, attrP, avBag);
                skua(pv3b, attrW, av5kg);
                skua(pv3b, attrP, avSack);

                Product p5 = prod("Vitamin C Aqua Stable", "vitamin-c-aqua-stable",
                                "Vitamin C bền vững trong nước, tăng sức đề kháng tôm",
                                "Vitamin C 35% dạng bột, bền pH 5-8, không bị oxy hóa nhanh...", bGN, catVit,
                                "Việt Nam", "GN-VTC",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p5_pjm6uv.jpg");
                ...
                skua(pv5a, attrW, av500g);
                skua(pv5a, attrP, avBag);
                skua(pv5b, attrW, av5kg);
                skua(pv5b, attrP, avSack);

                Product p6 = prod("Vôi Dolomite Cân Bằng pH Ao", "voi-dolomite-xu-ly-ao",
                                "Cân bằng pH đáy ao, kiềm hóa môi trường nuôi tôm",
                                "Vôi dolomite CaMg(CO3)2 nghiền mịn, độ tinh khiết >95%...", bCP, catMin, "Việt Nam",
                                "CP-DOLO",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p6_v8w3zv.jpg");
                ...
                skua(pv6a, attrW, av25kg);
                skua(pv6a, attrP, avSack);
                skua(pv6b, attrW, av50kg);
                skua(pv6b, attrP, avSack);

                Product p7 = prod("Bacillus BioPlus Vi Sinh Đáy Ao", "bacillus-bioplus",
                                "Vi sinh phân giải khí độc H2S, NH3 tích tụ đáy ao",
                                "Bacillus subtilis mật độ 10^9 CFU/g, Bacillus licheniformis...", bGN, catPro,
                                "Việt Nam", "GN-BIO",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p7_p8v6zv.jpg");
                ...
                skua(pv7a, attrW, av500g);
                skua(pv7a, attrP, avBottle);
                skua(pv7b, attrW, av5kg);
                skua(pv7b, attrP, avSack);

                Product p8 = prod("OTC-80 Oxytetracycline Kháng Khuẩn", "otc-80-oxytetracycline",
                                "Kháng khuẩn phổ rộng cho tôm cá bị đốm trắng, hoại tử",
                                "Oxytetracycline HCl 80% dạng bột tan nước, phổ kháng khuẩn rộng...", bCP, catMed,
                                "Việt Nam", "CP-OTC",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p8_v8w3zv.jpg");
                ...
                skua(pv8a, attrW, av500g);
                skua(pv8a, attrP, avBox);
                skua(pv8b, attrW, av1kg);
                skua(pv8b, attrP, avBox);

                Product p9 = prod("Thức Ăn Cá Da Trơn Tomboy 26%", "thuc-an-ca-da-tron-tomboy-26",
                                "Thức ăn viên nổi cho cá tra, cá basa, protein 26%",
                                "Tomboy 26% protein, lipid 5%, dạng viên nổi 2.5mm...", bTomboy, catFF, "Việt Nam",
                                "TBY-CAT",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p9_pjm6uv.jpg");
                ...
                skua(pv9a, attrW, av5kg);
                skua(pv9a, attrP, avBag);
                skua(pv9b, attrW, av25kg);
                skua(pv9b, attrP, avSack);

                Product p10 = prod("Máy Đo pH-DO-Nhiệt Độ Cầm Tay", "may-do-ph-do-nhiet-do",
                                "Thiết thiết bị đo đa chỉ tiêu: pH, oxy hòa tan, nhiệt độ ao nuôi",
                                "Độ chính xác pH ±0.01, DO ±0.1 mg/L, Temp ±0.5°C, chống nước IP67...", bGN, catMeas,
                                "Nhật Bản", "GN-METER",
                                "https://res.cloudinary.com/dcl7geun3/image/upload/v1731514488/p10_v8w3zv.jpg");
                ...
                InventoryNote nMain1 = saveNote("PN-MAIN-001", mainWh, supCP, kho1, now.minusDays(60),
                                InventoryNoteStatus.COMPLETED, bd(101_300_000));
                ...
                InventoryNote nMain2 = saveNote("PN-MAIN-002", mainWh, supGN, kho1, now.minusDays(30),
                                InventoryNoteStatus.COMPLETED, bd(157_400_000));
                ...
                InventoryNote nMain3 = saveNote("PN-MAIN-003", mainWh, supCP, kho1, now.minusDays(14),
                                InventoryNoteStatus.PENDING, bd(40_800_000));
                ...
                InventoryNote nCn1a = saveNote("PN-CN1-001", branch1, supCP, kho2, now.minusDays(55),
                                InventoryNoteStatus.COMPLETED, bd(44_120_000));
                ...
                InventoryNote nCn1b = saveNote("PN-CN1-002", branch1, supGN, kho2, now.minusDays(28),
                                InventoryNoteStatus.COMPLETED, bd(23_000_000));
                ...
                InventoryNote nCn1c = saveNote("PN-CN1-003", branch1, supMW, kho2, now.minusDays(7),
                                InventoryNoteStatus.PENDING, bd(13_050_000));
                addDetail(nCn1c, pv6a, 50, bd(85_000), "LOT-CN1-VOIA-002");
                addDetail(nCn1c, pv7a, 40, bd(220_000), "LOT-CN1-BIO-001");

                // ── 12. KHÁCH HÀNG ──────────────────────────────────────────────
                customerRepository.save(Customer.builder().user(user1).name("Nguyễn Văn Tôm").phone("0911000001")
                                .email("user1@gmail.com").gender(CustomerGender.MALE).provinceId("79")
                                .addressDetail("Cà Mau").status(CustomerStatus.ACTIVE).build());
                customerRepository.save(Customer.builder().user(user2).name("Trần Thị Cua").phone("0911000002")
                                .email("user2@gmail.com").gender(CustomerGender.FEMALE).provinceId("94")
                                .addressDetail("Sóc Trăng").status(CustomerStatus.ACTIVE).build());
                customerRepository.save(Customer.builder().user(user3).name("Lê Minh Nuôi").phone("0911000003")
                                .email("user3@gmail.com").gender(CustomerGender.MALE).provinceId("95")
                                .addressDetail("Bạc Liêu").status(CustomerStatus.ACTIVE).build());
                customerRepository.save(Customer.builder().user(user4).name("Phạm Hữu Cá").phone("0911000004")
                                .email("user4@gmail.com").gender(CustomerGender.MALE).provinceId("92")
                                .addressDetail("Cần Thơ").status(CustomerStatus.ACTIVE).build());
                ...
                Order o1 = orderRepository.save(Order.builder()
                                ...
                                .paymentMethod(PaymentMethod.COD).paymentStatus(PaymentStatus.PAID)
                                .shippingAddress("Cà Mau")
                ...
                Order o4 = orderRepository.save(Order.builder()
                                ...
                                .paymentMethod(PaymentMethod.PAYOS).paymentStatus(PaymentStatus.PAID)
        ...
        private Permission pMod(String name, String code, PermissionGroup group) {
                return permissionRepository.findByCode(code)
                                .orElseGet(() -> permissionRepository.save(Permission.builder()
                                                .name(name).code(code).groupName(group).type(PermissionType.MODULE)
                                                .build()));
        }
        ...
        private Role saveRole(String slug, String displayName, boolean isSystem, Set<Permission> perms) {
                return roleRepository.findBySlug(slug)
                                .map(existingRole -> {
                                        ...
                                        // Merge permissions thay vì replace để tránh lỗi immutable collection
                                        existingRole.getPermissions().clear();
                                        existingRole.getPermissions().addAll(perms);
                                        return roleRepository.save(existingRole);
                                })
                                .orElseGet(() -> roleRepository.save(Role.builder()
                                                .slug(slug).displayName(displayName).isSystem(isSystem).isActive(true)
                                                .description("Vai trò " + displayName).permissions(new HashSet<>(perms))
                                                .build()));
        }

        private Branch saveBranch(String code, String type, String name, String phone, String email, String address,
                        Double lat, Double lng, Integer provinceId, Integer districtId) {
                return branchRepository.findByBranchCode(code).orElseGet(() -> branchRepository.save(Branch.builder()
        ...
        private Product prod(String name, String slug, String shortDesc, String desc,
                ...
                Product p = productRepository.findBySlug(slug).orElseGet(() -> productRepository.save(Product.builder()
        ...
        private void skua(ProductVariant variant, Attribute attr, AttributeValue attrVal) {
                skuAttributeValueRepository.save(
                                SKUAttributeValue.builder().sku(variant).attribute(attr).attributeValue(attrVal)
                                                .build());
        }

        private void inv(ProductVariant variant, Branch branch, int qty, BigDecimal importPrice, String batchCode,
                        int minStock, LocalDateTime now, User user) {
