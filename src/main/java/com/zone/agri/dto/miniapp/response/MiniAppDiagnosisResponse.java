...
/**
 * Response cho:
 * - POST /api/miniapp/diagnosis (createdAt = null, excluded by NON_NULL)
 * - GET  /api/miniapp/diagnosis/{id} (createdAt = thời điểm lưu history)
 */
@Data
@Builder
@JsonInclude(JsonInclude.Include.NON_NULL)
public class MiniAppDiagnosisResponse {
