...
public class CategoryController {
    ...
    @Operation(summary = "Lấy tất cả danh mục", description = "Trả về danh sách danh mục sản phẩm theo cấu trúc cây hoặc phẳng.")
    ...
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Tạo thành công", content = @Content(schema = @Schema(implementation = Category.class))),
    ...
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Tìm thấy danh mục", content = @Content(schema = @Schema(implementation = CategoryDTO.class))),
