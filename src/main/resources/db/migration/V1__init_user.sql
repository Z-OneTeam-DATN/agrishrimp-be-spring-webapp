...
CREATE TABLE users (
    ...
    -- Newsletter
                       is_newsletter_subscribed BOOLEAN DEFAULT TRUE
                           COMMENT 'True: Nhận tin KM, False: Không nhận',

    -- Trạng thái tài khoản
                       status ENUM('ACTIVE', 'INACTIVE', 'BANNED', 'UNVERIFIED')
        DEFAULT 'UNVERIFIED',
...
CREATE TABLE otp_verifications (
                                   ...
                                   otp_type ENUM('REGISTER_VERIFY', 'FORGOT_PASSWORD')
        NOT NULL DEFAULT 'REGISTER_VERIFY',
                                   channel ENUM('ZALO', 'EMAIL', 'SMS_BRANDNAME')
